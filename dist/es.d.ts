...
export class CrmEnv {
     ...
     * @param {boolean} [env.useFetchQueue=false] - When true, send sequential fetch requests
...
declare class EditObject extends RemoteObject {
     ...
     * @param {string} entity - The entity name, e.g. "Comp"
     * @param {string|number} [key=0] - The key of the record. Use key = 0 to create a new record
     */
    constructor(remoteAPI: RemoteAPI, editHandle: number, entity: string, key?: string | number);
    entity: string;
    key: string | number;
    edithandle: number;
    data: any;
     ...
     * @param {number} [fileVersion=0]
     * @returns {AttachmentObject}
     */
    getAttachment(fileKey: string, fileVersion?: number): AttachmentObject;
    /**
     ...
     * @param {string} detail - The detail name, e.g. "Comp"
     * @param {string|number} detailKey - The key of the detail
     * @param {boolean} [linkMainCompany=false]
     * @param {boolean} [retrieveName=false]
     */
    insertDetail(detail: string, detailKey: string | number, linkMainCompany?: boolean, retrieveName?: boolean): void;
    /**
     * Updates field values of a detail relation. When the detail relation doesn't exist, an exception is thrown.
     * @param {string} detail - The detail name, e.g. "Comp"
     * @param {string|number} detailKey - The key of the detail. If detailKey is 0, the current detail record is used
     * @param {object} fieldsObj, e.g. {"OPENED": "0"}
     */
    updateDetail(detail: string, detailKey: string | number, fieldsObj: object): void;
    /**
     * Deletes a detail relation
     * @param {string} detail - The detail name, e.g. "Comp"
     * @param {string|number} detailKey - The key of the detail
     */
    deleteDetail(detail: string, detailKey: string | number): void;
    /**
     ...
     * @param {string} key - The key of the source record.
     ...
     */
    copyFromExisting(key: string, minTableView?: number, maxTableView?: number): void;
    /**
